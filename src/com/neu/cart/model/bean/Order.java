...
public class Order {
	...
	private int orderId;
	private List<ShoppingCartInfo> products;
	...
	public List<ShoppingCartInfo> getProducts() {
		return products;
	}
	public void setProducts(List<ShoppingCartInfo> products) {
	...
	public void setGiftCardPay(double giftCardPay) {
