! function(e) {
	...
	jQuery(function(e) {
		...
		0 !== e("#comment").length && u(), S(a), g(), i.slider({
			...
			e(this).data("visible") || (c(e(this), {
				onLoad: function(t) {
					t.find(".J_videoTrigger").on("click", function(t) {
						t.preventDefault(), document.domain = "mi.com", w.find(".modal-hd .title").text(e(this).attr("data-video-title")).end().find(".modal-bd").html('<iframe id="miPlayerIframe" width="880" height="536" src="//hd.mi.com/f/zt/hd/miplayer2/index.html?vurl=' + e(this).attr("data-video") + "&poster=" + e(this).attr("data-video-poster") + '" frameborder="0" allowfullscreen></iframe>').find("iframe").focus(), w.modal({
							show: !0,
							backdrop: "static"
						})
					}), w.on("hide", function() {
