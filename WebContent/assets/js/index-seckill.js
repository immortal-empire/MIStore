		...
		$.ajax({
				...
				success:function(data)
				{
					for(var i=1; i<data.length+1;i++){
						var str = '<li class="item rainbow-item-'+i+'" style="float:left;width:222px;margin-right:10px">';
						str+='<a href="seckill/seckill.html" target="_blank" style="color: #757575;text-decoration: none;">';
						str+='<div class="bg" ></div></a><div class="content">';
						str+='<a class="thumb exposure" style="color: #757575;text-decoration: none;"><img src="cartAndOrder/img/'+data[i-1].picture+'/cart.jpg" style="border: 0;" alt></a>';
						str+='<h3 class="title" id="productName" ><a style="text-decoration: none;">'+data[i-1].productName+' '+data[i-1].color+' '+data[i-1].configuration+'</a></h3>';
